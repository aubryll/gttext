================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : GT Project Overview
===============================================================================

The application wizard has created this GT application for 
...
res\GT.ico
    ...
    icon is included by the main resource file GT.rc.
...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in GT.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////

The application wizard creates one document type and one view:

GTDoc.h, GTDoc.cpp - the document
    These files contain your CGTDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CGTDoc::Serialize).

GTView.h, GTView.cpp - the view of the document
    These files contain your CGTView class.
    CGTView objects are used to view CGTDoc objects.
